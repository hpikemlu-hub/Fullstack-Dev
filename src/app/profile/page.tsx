              ...
              <CardContent>
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                  ...
                  <div className="space-y-8">
                    <div className="text-center">
                      <div className="relative inline-block">
                        <Avatar className="w-40 h-40 border-4 border-white shadow-2xl">
                          <AvatarFallback className="bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-600 text-white text-4xl font-black">
                            {user.namaLengkap ? user.namaLengkap.split(' ').map(n => n[0]).join('') : (user.email?.charAt(0).toUpperCase() || 'U')}
                          </AvatarFallback>
                        </Avatar>
                      ...
                      <h2 className="text-3xl font-black text-gray-900 mt-6">
                        {user.namaLengkap || 'Professional Government Employee'}
                      </h2>
                  ...
                  <div className="space-y-8">
                    ...
                    <div className="space-y-6">
                      {[
                        { label: 'Full Name', icon: User, value: user.namaLengkap || 'Will be fully editable', placeholder: 'Enter your complete name' },
